...
class Wit(object):
    ...
    def delete_role(self, entity_name, role_name, headers=None, verbose=None):
        ...
        if verbose:
            params['verbose'] = True
        endpoint = '/entities/' + urllib.parse.quote_plus(entity_name) + ":" + urllib.parse.quote_plus(role_name)
        resp = req(self.logger, self.access_token, 'DELETE', endpoint, params, headers=headers)
        return resp
    ...
    def delete_keyword(self, entity_name, keyword_name, headers=None, verbose=None):
        ...
        if verbose:
            params['verbose'] = True
        endpoint = '/entities/' + urllib.parse.quote_plus(entity_name) + "/keywords/" + urllib.parse.quote_plus(keyword_name)
        resp = req(self.logger, self.access_token, 'DELETE', endpoint, params, headers=headers)
        return resp
    ...
    def delete_synonym(self, entity_name, keyword_name, synonym_name, headers=None, verbose=None):
        ...
        if verbose:
            params['verbose'] = True
        endpoint = '/entities/' + urllib.parse.quote_plus(entity_name) + "/keywords/" + urllib.parse.quote_plus(keyword_name) + "/synonyms/" + urllib.parse.quote_plus(synonym_name)
        resp = req(self.logger, self.access_token, 'DELETE', endpoint, params, headers=headers)
        return resp
    ...
    def delete_trait_value(self, trait_name, value_name, headers=None, verbose=None):
        ...
        if verbose:
            params['verbose'] = True
        endpoint = '/traits/' + urllib.parse.quote_plus(trait_name) + "/values/" + urllib.parse.quote_plus(value_name)
        resp = req(self.logger, self.access_token, 'DELETE', endpoint, params, headers=headers)
        return resp
    ...
    def app_version_info(self, app_id, tag_id, headers=None, verbose=None):
        ...
        if verbose:
            params['verbose'] = True
        endpoint = '/apps/' + urllib.parse.quote_plus(app_id) + "/tags/" + urllib.parse.quote_plus(tag_id)
        resp = req(self.logger, self.access_token, 'GET', endpoint, params, headers=headers)
        return resp
    ...
    def delete_app_version(self, app_id, tag_name, headers=None, verbose=None):
        ...
        params = {}
        headers = headers or {}
        endpoint = '/apps/' + urllib.parse.quote_plus(app_id) + "/tags/" + urllib.parse.quote_plus(tag_name)
        if verbose:
            params['verbose'] = verbose
        resp = req(self.logger, self.access_token, 'DELETE', endpoint, params, headers=headers)
        return resp
    ...
    def create_synonym(self, entity_name, keyword_name, synonym, headers=None, verbose=None):
        ...
        params = {}
        headers = headers or {}
        endpoint = '/entities/' + urllib.parse.quote_plus(entity_name) + "/keywords/" + urllib.parse.quote_plus(keyword_name) + "/synonyms"
